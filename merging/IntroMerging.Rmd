...
B. Interestingly, a number of players do not have salary data. Use the appropriate join to create a new data.frame "no_salary" containing players without an entry in the "Salary" table. Use the commands head(no_salary), tail(no_salary), and dim(no_salary) to display your results.
